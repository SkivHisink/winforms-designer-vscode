...
[![Version 1.8](https://img.shields.io/badge/version-1.8-brightgreen.svg)](#-support-matrix)
...
safe source-first tab ordering in 1.7.0, and exact placement, a self-maintaining workspace toolbox plus design-time
safety in 1.8.0 (opening a form no longer runs your application, holds your build output, or puts windows on your
screen) - plus the planned line: the daily naming/navigation/default-event loop (1.9.0),
multi-object properties (1.10.0), precision layout (1.11.0), form/user-control scaffolding (1.12.0), assets and menu
...
The safety core has fast C# and TypeScript unit coverage; the webview UI is validated headless (619 checks
across 154 tests), startup/render latency is guarded by a repeatable performance baseline, and activation,
