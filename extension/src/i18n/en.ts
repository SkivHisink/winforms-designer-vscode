...
export const en: Catalog = {
  ...
  'designer.spacing.hIncrease': 'Increase horizontal spacing by one grid cell',
  'designer.spacing.hDecrease': 'Decrease horizontal spacing by one grid cell',
  'designer.spacing.hRemove': 'Remove horizontal spacing',
  'designer.spacing.vIncrease': 'Increase vertical spacing by one grid cell',
  'designer.spacing.vDecrease': 'Decrease vertical spacing by one grid cell',
  'designer.spacing.vRemove': 'Remove vertical spacing',
  ...
  'designer.owner.missingInitializeComponent': 'Designer open refused: the generated source does not contain a unique InitializeComponent body.',
  'designer.owner.emptyInitializeComponentReadOnly': 'Visual Studio-compatible empty surface: InitializeComponent is missing. The preview is read-only until the generated method is restored.',
  'designer.owner.ambiguous': 'Designer open refused: the generated source is compiled by more than one project ({owners}).',
  'designer.owner.nestedUnsupported': 'Designer open refused: Visual Studio cannot design a Form nested inside another type ({type}).',
  'designer.owner.noProject': 'Designer open refused: no bounded workspace project owns this generated source.',
  'designer.owner.failed': 'Designer open refused: document ownership validation failed ({code}).',
  'host.tierD.activeXRefused': 'Designer open refused: ActiveX control(s) {controls} require an x86/COM design host, which this release does not provide.',
  'host.tierD.x86Refused': 'Designer open refused: {assembly} requires an x86 process, but this release has no x86 design worker.',
  'host.transactionRecovery.manual': 'WinForms Designer could not safely recover {count} interrupted transaction(s). No conflicting file was overwritten. See the WinForms Designer output for journal paths and manual resolution details.',
  ...
  'designer.notice.localizationEditable': 'Localizable form — editing {culture}. Values are written to the .resx.',
  'designer.notice.collapse': 'Collapse',
  'designer.notice.expand': 'Expand',
  ...
  'localization.notLocalizable': '{form} is not localizable yet — its text and layout live in code, not in resources.',
  'localization.addAction': 'Add Localization',
  'localization.resxPending': 'Now editing {culture} — change a property in Properties (Text, for example) and it is saved to {file}.',
  ...
  'designer.status.spacingSelectMore': 'select 2+ controls to adjust spacing',
  'designer.status.spacingSameParent': 'spacing commands require controls in the same container',
  'designer.status.duplicateDrag': 'duplicate {count} → Δ({dx}, {dy})',
  ...
  'designer.status.geometry': 'position / size → x={x}, y={y}, w={w}, h={h}',
  ...
  'panel.props.multiSelection': '{n} selected controls',
  'panel.props.multiSelectionHint': 'Only shared writable properties are shown. Each edit is one all-or-nothing transaction.',
  ...
  'panel.mainTab.data': 'Data Sources',
  'panel.data.refresh': 'Refresh',
  'panel.data.navigator': 'Add navigator',
  'panel.data.loading': 'Open the Data Sources tab to scan recognized project types.',
  'panel.data.dragTip': 'Click to generate at the form default, or drag onto the canvas.',
  'panel.data.none': 'No supported project object types or application settings were found.',
  'panel.data.unavailable': 'Data Sources are unavailable for this form.',
  'panel.data.newBindingSource': '(new BindingSource)',
  'panel.data.details': 'Details',
  'panel.data.grid': 'Grid',
  'panel.data.addColumns': 'Add missing columns',
  'panel.data.settings': 'Application settings',
  'panel.data.bindSelected': 'Bind selected',
  ...
  'panel.image.project': 'Project…',
  'panel.image.projectTip': 'Choose an existing image or icon from the project resources',
  ...
  // Explorer Add scaffolding (GitHub #4): all companion files + any classic-project items are one atomic edit.
  'host.scaffold.kind.form': 'Windows Form',
  'host.scaffold.kind.userControl': 'User Control',
  'host.scaffold.kind.component': 'Component',
  'host.scaffold.kind.class': 'Class',
  'host.scaffold.prompt.title': 'Add {kind}',
  'host.scaffold.prompt.description': 'Enter the C# type name. The .cs suffix is optional.',
  'host.scaffold.created': '{kind} {name} was created.',
  'host.scaffold.error.noResource': 'Use Add from a local file or folder in Explorer.',
  'host.scaffold.error.invalidName': 'Enter one valid C# identifier (no path, punctuation, or reserved keyword).',
  'host.scaffold.error.projectUnsupported': 'The item cannot be added safely here ({reason}: {detail}). Select a folder owned by one unambiguous C# project with a standard static project file; Forms and User Controls additionally require WinForms. No files were changed.',
  'host.scaffold.error.fileCollision': 'A generated file already exists ({detail}). Choose another type name; no files were changed.',
  'host.scaffold.error.projectChanged': 'The project changed while the item was being prepared. Run Add again; no files were changed.',
  'host.scaffold.error.applyFailed': 'VS Code could not apply the complete Add operation. No partial scaffold was accepted.',
  'host.scaffold.error.unexpected': 'The item could not be created: {error}',
  ...
  'host.renameComponent.prompt': 'Rename {old}',
  ...
  'status.localizeDone': 'Form is now localizable — {count} value(s) moved into the neutral .resx.',
  'status.localizeRejected': 'Could not make the form localizable: {reason}',
  'status.localizeNotWritten': 'The form was converted, but its .Designer.cs could not be written: {reason}. Undo (Ctrl+Z) reverts the conversion.',
  ...
  'status.multiPropSet': 'set {prop} on {n} selected controls — unsaved',
  ...
  'status.projectResourcesNone': 'no compatible strongly typed project image resources found',
  'status.projectResourceSet': 'set {id}.{prop} from project resources — unsaved (project resources unchanged)',
  ...
  'status.multiPropReset': 'reset {prop} on {n} selected controls — unsaved',
  ...
  'status.noDefaultEvent': '{id} has no browsable default event',
  ...
  'advisor.highDpi.noActive': 'Open and focus a WinForms designer first.',
  'advisor.highDpi.diffTitle': 'High-DPI scaling fix — {file}',
  'advisor.highDpi.previewReady': 'The exact High-DPI source change is open in a read-only diff.',
  'advisor.highDpi.apply': 'Apply Fix',
  'advisor.highDpi.applied': 'High-DPI scaling fix applied — unsaved.',
  'advisor.highDpi.notApplicable': 'This form does not have an editable AutoScaleMode.None assignment.',
  'advisor.highDpi.refused': 'The High-DPI fix could not be applied safely. Refresh the designer and preview it again.',
};
