...
export const en: Catalog = {
  ...
  'chooseItems.unsupportedScope': 'COM and WPF components are intentionally unsupported; only .NET components can be added.',
  ...
  'designer.diag.target': 'Target: {target}',
  'designer.diag.retry': 'Retry',
  'designer.diag.rebuild': 'Rebuild',
  'designer.diag.chooseAssembly': 'Choose Control Assembly…',
  'designer.diag.copy': 'Copy Diagnostics',
  'designer.diag.partialCause': 'One or more InitializeComponent statements could not be represented.',
  'designer.diag.compiledFallback': '.NET Framework preview fell back to the last compiled build.',
  'designer.diag.noDetails': 'No additional details were reported.',
  // 0.10.0 trust-floor — persistent read-only notice for a [Localizable(true)] form.
  'designer.notice.localizationEditable': 'Localizable form — editing {culture} resources. ApplyResources-backed properties are written to the selected .resx; structural source edits stay protected.',
  'localization.default': '(Default)',
  'localization.defaultDetail': 'Neutral resources (the plain sibling .resx).',
  'localization.pickTitle': 'Select form localization culture',
  'localization.pickPlaceholder': 'Choose the .resx culture to preview and edit',
  'localization.create': 'Create culture…',
  'localization.createDetail': 'Enter a culture name; its .resx is created by the first edit.',
  'localization.createTitle': 'Create form localization culture',
  'localization.createPrompt': 'Enter a .NET culture name, for example fr-FR or ar-SA.',
  'localization.invalidCulture': 'Enter a valid culture name such as fr-FR.',
  ...
  'designer.status.freePlacement': 'free placement → x={x}, y={y}, w={w}, h={h}',
  ...
  'designer.menu.moveTabLeft': 'Move Tab Left',
  'designer.menu.moveTabRight': 'Move Tab Right',
  ...
  'host.buildTask.running': '“{name}” is running. The last successful preview is view-only until it finishes.',
  'host.buildTask.generic': 'Build or test task',
  'host.buildTask.external': 'An external build (Visual Studio / MSBuild)',
  'host.buildTask.cause': 'The .NET Framework preview released its compiled assembly so the task can replace the output.',
  'host.task.none': 'No {group} tasks are available in this workspace.',
  'host.task.scope.global': 'global task',
  'host.task.scope.workspace': 'workspace task',
  'host.task.pickBuild': 'Choose the build task to run',
  'host.task.pickTest': 'Choose the test task to run',
  'host.task.startFailed': 'The task could not be started: {error}',
  ...
  'status.saved': 'saved',
  'status.localizableSourceBlocked': 'This operation changes generated source and is not supported on a localizable form. ApplyResources-backed property edits remain enabled.',
  'status.localizationCultureSet': 'Form localization culture: {culture}',
  'status.localizedResourceSet': 'Localized resource saved for {culture}',
  ...
  'status.diagnosticsCopied': 'Designer diagnostics copied to the clipboard.',
  'status.localizableSaveRefused': 'This recovered generated-source edit can’t be saved for a localizable form because it would diverge from the .resx. Revert the file to discard it.',
  ...
  'status.toolboxDiscovery': 'toolbox discovery: {controls} controls; {directories} directories; {skipped} skipped{limit}. Details: WinForms Designer output.',
  'status.toolboxDiscoveryBudget': ' (budget reached)',
  ...
  'imageList.rename': 'Rename image key…',
  'imageList.renameTitle': 'Rename key for image #{index}',
  'imageList.renamePrompt': 'Enter a unique ImageKey.',
  'imageList.moveUp': 'Move image up…',
  'imageList.moveDown': 'Move image down…',
  'imageList.keyRequired': 'The image key cannot be empty.',
  'imageList.keyTooLong': 'The image key must be 256 characters or fewer.',
  'imageList.keyDuplicate': 'That image key is already in use.',
  'imageList.done': 'Done',
